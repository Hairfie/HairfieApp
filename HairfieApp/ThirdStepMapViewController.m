...
-(void)centerMap
{
    MKCoordinateRegion viewRegion = MKCoordinateRegionMakeWithDistance(_businessLocation.coordinate, 0.5*METERS_PER_MILE, 0.5*METERS_PER_MILE);
    
    [_businessMapView setRegion:viewRegion animated:YES];
    _businessMapView.camera.altitude *= 1.2;
}
